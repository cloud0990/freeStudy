	...
	<div id="box">
	   <div>
	      ...
	      <div style="margin-top: 30px;">
	      		<table class="table" id="insert_box">
	      			<tr>
	      				<td>닉네임</td>
	      			...
	      			<tr>
	      				<td colspan="2" align="center">
	      					<div style="margin-bottom: 20px;">
		      					<input type="button" value="회원가입" id="btn_register" class="btn btn-default" disabled="disabled" onclick="send(this.form);">
		      					<input type="button" value="목록보기" id="btn_list"     class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/board/list.do'">
	      					</div>
	      				</td>
	      			</tr>
	      		</table>	
